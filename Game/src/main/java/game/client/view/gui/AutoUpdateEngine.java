...
public class AutoUpdateEngine {
	...
	private void manageUpdate(int time, Sheepland obj, boolean isSocketMode) throws RemoteException {
    	...
    	if(!isSocketMode){
	    	...
	    	while(obj.isRunningGame()){
	    		...
	    		try {
					...
					cci.silentExceptionClientLogger("AutoUpdateEngine - impossible to wait", e);
				}
	    	...
	    	//debug
	    	//showOnClient("NEW GUI UPDATE MANAGER CREATED | on port " + clientPort
