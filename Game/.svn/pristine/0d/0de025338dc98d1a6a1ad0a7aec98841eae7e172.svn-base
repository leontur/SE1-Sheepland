...
public class CheckMoveTest {
	...
	/**
	 * Check if the sequence done of move is correct
	 */
	@Test
	...
	public void findRegionsWithSamePosTest(){
		...
		/**
		 * Check if there is af least a sheep in the regions around
		 */
		@Test
		...
		/**
		 * Check if there is at least a sheep in the regions around
		 */
		@Test
