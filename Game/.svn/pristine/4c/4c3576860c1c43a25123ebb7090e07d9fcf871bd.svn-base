...
public class Sheepland extends FrameObject {
	...
	private static final int BACKGROUNDZINDEX = 1;
	private static final int OBJECTSZINDEX = 10;
	...
	/**
	 * Initialize all black sheep in map
	 */
	...
	/**
	 * Initialize all shepherds in map
	 * @param num
	 */
	private void populateShepherds(int num) {
		...
		for(int i=0; i<lim; i++){
			...
			//DEFINE ID - COLOR - PLAYER ASSOCIATION 
			if(variant){
				//FOR VARIANT
				int player = currPlayerNum==0 ? 
						(i<2 ? 0 : 1)
						:
						(i<2 ? 1 : 0)
						;
	...
	/**
	 * Initialize all enclosures in map
	 * @param num
	 */
	...
	/**
	 * Initialize all final enclosures in map
	 * @param num
	 */
	...
	/**
	 * Initialize all initial cards in map
	 * @param num
	 */
	...
	/**
	 * Initialize all standard cards in map
	 * @param num
	 */
	...
	/**
	 * Set a new region busy for the game
	 * @param newlist
	 */
	...
	/**
	 * Set a new shepherd for player's turn
	 * @param newlist
	 */
	...
	/**
	 * Set new dinars for player's turn
	 * @param i
	 */
	...
	/**
	 * Set new initial card for player's turn
	 * @param i
	 */
	...
	/**
	 * Set new standard card for player's turn
	 * @param newlist
	 */
	...
	/**
	 * Set new standard enclosure for player's turn
	 * @param i
	 */
	...
	/**
	 * Set new final enclosure for player's turn
	 * @param i
	 */
	...
	/**
	 * Set new number dice for player's turn 
	 * @param i
	 */
	...
	/**
	 * Set a new position busy for the game
	 * @param newlist
	 */
	...
	/**
	 * Set a new number for the player
	 * @param i
	 */
	...
	/**
	 * Set a new number for the current player
	 * @param i
	 */
	...
	/**
	 * Set a new request to the server
	 * @param command
	 * @param options
	 */
	...
	/**
	 * Get last command to the server
	 * @return
	 */
	...
	/**
	 * Get the last command options to the server
	 * @return
	 */
	...
	public void performUpdate(){
    	...
    	MapUpdate.updateDiceOnTheGo(numDice, diceNum, numbers);
