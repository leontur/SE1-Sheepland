...
public class Database implements DatabaseInterface {
	...
	* -Variant: 2  players
	*/ 
	private static final int INITIAL_PLOT_CARDS_NUM = 1;
	private static final int STANDARD_PLOT_CARDS_NUM = 5;
	private static final int PLOT_TYPES_NUM = 6; //LINKED: C
	private static final int TOT_PLOT_CARDS_NUM = STANDARD_PLOT_CARDS_NUM * PLOT_TYPES_NUM;
	private static final int REGION_PER_PLOT_NUM = 3;
	
	private static final int ISLAND_NUM = 1;
	private static final int REGION_NUM = 18; //LINKED: E
	private static final int CITY_REGION_NUM = 1; //LINKED: D
	
	private static final int ENCLOSURE_NUM = 20;
	private static final int FINAL_ENCLOSURE_NUM = 12;
	
	private static final int POSITION_NUM = 42; //LINKED: B
	
	private static final int SHEEP_NUM = 18;
	private static final int SHEEP_B_NUM = 1;
	private static final int SHEEP_VALUE = 1;
	private static final int SHEEP_B_VALUE = 2;
	
	private static final int DINARS_TOT_NUM = 80;
	private static final int DINAR_ASSIGN_NUM = 20;
	private static final int DINAR_ASSIGN_VARIANT_NUM = 30;
	
	private static final int DICE_NUM = 1;
	
	private static final int TOT_PLAYER_MIN_NUMBER = 2; 
	private static final int TOT_PLAYER_MAX_NUMBER = 4; 
	private static final int TOT_SHEPHERD_NUM = TOT_PLAYER_MIN_NUMBER + TOT_PLAYER_MAX_NUMBER; //LINKED: A
	private static final int TOT_SHEPHERD_VARIANT_NUM = 2;
	
	private static final int MAX_MOVEMENT_COUNT = 3;
	private static final int SHEPHERD_MOVEMENT_DINARS_COST = 1;
	private static final int PLOT_CARDS_VALUE_MULTIPLIER = 1;	
	
	private static final List<String> SHEPHERD_COLOR = Arrays.asList("Red", "Blue", "Green", "Yellow", "Red", "Blue"); //LINKED: A
	private static final List<String> PLOT_TYPES = Arrays.asList("Forest", "Swamp", "Desert", "Mountain", "Grain", "Hill"); //LINKED: C	
	private static final List<String> CITY_TYPES = Arrays.asList("Sheepsburg"); //LINKED: D
	
	private static final List<Integer> POSITION_VIEWER_VALUE = Arrays.asList(1,2,5,1,5,4,6,2,1,3,4,6,4,5,2,1,3,6,1,3,5,2,1,3,3,2,6,5,4,2,1,4,3,2,1,5,6,2,1,3,4,2); //LINKED: B
	
	//row: region id | index: adjacent positions || note: positions number is +1 !
	private static final List<int[]> POSITIONS_PER_REGION = Arrays.asList(
					new int [][] { 
					{1,41,42},
					{1,2,10,11},
					{8,9,10,12,13,14},
	...
	private static final List<int[]> POSITIONS_PER_CITY = Arrays.asList(
					new int [][] { 
	...
	private static final List<int[]> POSITIONS_ADJACENTS_MATRIX = Arrays.asList(
					new int [][] {
					{42,11},//1
					{9,10},//2
					{9,8},//3
